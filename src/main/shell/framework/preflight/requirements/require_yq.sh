...
__fw_requirements_prepare_yq() {
  ...
  *)
  ...
  #   1 - Failed
  #######################################
  __fw_requirements_prepare_yq_fix_yum_repo_for_centos7() {
    __os_release=""
    ...
    *) return 0 ;;
    ...
    __fw_requirements_prepare_yq_run sed -i -r \
  ...
  __fw_requirements_prepare_yq_install_deps() {
    ...
    if command -v yum >/dev/null 2>&1; then
      ...
      __fw_requirements_prepare_yq_fix_yum_repo_for_centos7 || return 1
